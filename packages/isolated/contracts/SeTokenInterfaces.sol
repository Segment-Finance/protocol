...
/**
 * @title SeTokenStorage
 * @author Segment
 * @notice Storage layout used by the `SeToken` contract
 */
// solhint-disable-next-line max-states-count
contract SeTokenStorage {
    /**
    ...
    // Initial exchange rate used when minting the first SeTokens (used when totalSupply = 0)
...
/**
 * @title SeTokenInterface
 * @author Segment
 * @notice Interface implemented by the `SeToken` contract
 */
abstract contract SeTokenInterface is SeTokenStorage {
     ...
     * @return Always true
     */
    function isSeToken() external pure virtual returns (bool) {
        return true;
    }
}
