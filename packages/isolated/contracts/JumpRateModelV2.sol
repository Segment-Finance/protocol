...
import { IAccessControlManagerV8 } from "../../governance-contracts/contracts/Governance/IAccessControlManagerV8.sol";

import { BaseJumpRateModelV2 } from "./BaseJumpRateModelV2.sol";

/**
 * @title Compound's JumpRateModel Contract V2 for V2 seTokens
 * @author Arr00
 * @notice Supports only for V2 seTokens
 */
