...
contract SRTConverterProxy is SRTConverterAdminStorage {
    /**
    ...
    /**
     * @notice Emitted when pendingImplementation is accepted, which means SRTConverter implementation is updated
     */
    ...
    ) nonZeroAddress(implementation_) nonZeroAddress(_srtAddress) nonZeroAddress(_sefAddress) {
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, "SRTConverterProxy::_setImplementation: admin only");
        require(implementation_ != address(0), "SRTConverterProxy::_setImplementation: invalid implementation address");
    ...
    /**
     * @notice Accepts new implementation of SRTConverter. msg.sender must be pendingImplementation
