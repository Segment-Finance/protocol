...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents {
    ...
    string public constant name = "Segment Governor Bravo";

    /// @notice The minimum setable proposal threshold
    uint public constant MIN_PROPOSAL_THRESHOLD = 150000e18; // 150,000 Sef

    /// @notice The maximum setable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 300000e18; //300,000 Sef
    ...
    uint public constant quorumVotes = 600000e18; // 600,000 = 2% of Sef
     ...
     * @param sefVault_ The address of the SefVault
    ...
    function initialize(
        ...
        require(sefVault_ != address(0), "GovernorBravo::initialize: invalid sef address");
        ...
        sefVault = SefVaultInterface(sefVault_);
    ...
    function propose(
        ...
        require(
            sefVault.getPriorVotes(msg.sender, sub256(block.number, 1)) >=
    ...
    function cancel(uint proposalId) external {
        ...
        require(
            msg.sender == guardian ||
                ...
                sefVault.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
    ...
    function castVoteInternal(address voter, uint proposalId, uint8 support) internal returns (uint96) {
        ...
        uint96 votes = sefVault.getPriorVotes(voter, proposal.startBlock);
